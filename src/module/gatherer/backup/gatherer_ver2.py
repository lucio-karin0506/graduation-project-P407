...
class Gatherer:
    ...
    def __init__(self, krx:bool =False):        
        """
        클래스 멤버변수를 초기화한다.
        ...
        if krx:
            ...
            self.krx_df.to_csv(os.getcwd()+'/stockFile/'+'KRX.csv')
...
if __name__ == "__main__":
    mod = Gatherer()
    df, _ = mod.get_stock('068270', '1990-01-01', 'today', interval='d')

    # print(df)

    df2, _ =  mod.get_stock('068270', '1990-01-01', 'today', interval='w')
