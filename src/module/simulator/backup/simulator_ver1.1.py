...
class Simulator:
    ...
    def read_file(self, file_name:str) -> None:
        ...
        self.stock_name = file_name.split('.')
    ...
    def set_option(self, buying_fee, selling_fee, National_tax,
        ...
        _n_p : bool
            주문서 가격정보 존재유무, false면 날짜 종가로 시뮬레이션
    ...
    def write_trlog(self, tpath='cwd'):        
        ...
        with open(tpath+'/tradingLogFile/'+self.stock_name+'_TradingLog.json', 'w+', encoding='utf-8') as make_file:
    ...
    def write_stlog(self, spath='cwd'):        
        ...
        #json.dumps(tdict, ensure_ascii=False, indent='\t')
        with open(spath+'/statusFile/'+self.stock_name+'_Status.json', 'w+', encoding='utf-8') as make_file:
...
if __name__ == '__main__':
    ...
    file = pathlib.Path(os.getcwd()+'/orderFile/SK하이닉스_w.json')
    text = file.read_text(encoding='utf-8')
    js = json.loads(text)
    order = pd.DataFrame(js)
