...
class vwma_cross_label_param(QDialog):
    ...
    def confirmIt(self):
        ...
        if self.short_period_edit.text() == '' or self.long_period_edit.text() == '' or self.window_size_edit.text() == '':
            ...
            label_indicator.add_vwma_cross(gathering_info['df'], gathering_info['short'], gathering_info['long'],
